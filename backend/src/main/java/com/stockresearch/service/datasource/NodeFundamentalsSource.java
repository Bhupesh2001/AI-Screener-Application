// backend/src/main/java/com/stockresearch/service/datasource/NodeFundamentalsSource.java
...
@Component
@Slf4j
public class NodeFundamentalsSource implements FundamentalsDataSource {

    private static final String SERVICE_URL = "http://localhost:5003/api/fundamentals/";
    private final WebClient webClient;
    private final ObjectMapper objectMapper;

    public NodeFundamentalsSource(ObjectMapper objectMapper) {
    ...
    public Optional<FundamentalsSnapshot> fetchFundamentals(String symbol) {
        try {
            ...
            log.error("Failed to fetch from Node fundamentals service for {}: {}", symbol, e.getMessage());
